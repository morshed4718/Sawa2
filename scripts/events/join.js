...
____________________________________
যেকোনো অভিযোগ অথবা হেল্প এর জন্য আমার BOSS MorshEd_কে নক করতে পারেন",👉FB link: https://www.facebook.com/profile.php?id=100075133524968&mibextid=ZbWKwL🤍`, attachment: fs.createReadStream(__dirname + "/Nayan/join/received_908287014131424.mp4")}, threadID));
})
.catch(error => {
    console.error(error);
});
